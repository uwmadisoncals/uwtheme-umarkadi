 ...
 */
 ...
 class ACF_Field_Nav_Menu_V5 extends acf_field {
 	...
 	public function __construct() {
 		$this->name     = 'nav_menu';
 		$this->label    = __( 'Nav Menu', 'uw-theme' );
 	...
 	public function render_field_settings( $field ) {
 		...
 		acf_render_field_setting( $field, array(
 			'label'        => __( 'Return Value', 'uw-theme' ),
 			'instructions' => __( 'Specify the returned value on front end', 'uw-theme' ),
 			'type'         => 'radio',
 			'name'         => 'save_format',
 			'layout'       => 'horizontal',
 			'choices'      => array(
 				'object' => __( 'Nav Menu Object', 'uw-theme' ),
 				'menu'   => __( 'Nav Menu HTML', 'uw-theme' ),
 				'id'     => __( 'Nav Menu ID', 'uw-theme' ),
 			),
 		) );

 		// Register the Menu Container setting
 		acf_render_field_setting( $field, array(
 			'label'        => __( 'Menu Container', 'uw-theme' ),
 			'instructions' => __( "What to wrap the Menu's ul with (when returning HTML only)", 'uw-theme' ),
 			'type'         => 'select',
 			'name'         => 'container',
